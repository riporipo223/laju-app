...
- [ ] T4.2 — Club War — confirmed to build 2026-09-23, mechanism finalized 2026-09-23 (§4.19 AC1-AC10), still not scheduled (lihat [phase-4-backlog.md](./phase-4-backlog.md))
...
- [ ] T4.20 — Premium subscription infrastructure — decided 2026-09-23 (§4.23 AC1-AC9); T4.2b, §4.5 AC4, and T4.4–T4.7 depend on it (lihat [phase-4-backlog.md](./phase-4-backlog.md))
