...
| Backend framework | Next.js (App Router, API routes) + TypeScript | **Rekomendasi**, bukan keputusan final — lihat catatan trade-off di bawah. Memanfaatkan familiarity existing (Next.js/TS) ~~dan bisa dipakai juga untuk admin/B2B dashboard di masa depan~~ (dashboard B2B tidak direncanakan lagi sejak 2026-09-23 — lihat product-spec.md §4.24). |
