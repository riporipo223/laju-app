...
3. **How it starts — targeted challenge/invite, explicitly NOT matchmaking.**
   ...
   - **Deliberately not automated matchmaking** — stays a distinct, separate concern from
     `tasks/phase-4-backlog.md` T4.3 ("Matchmaking between clubs," ~~still Non-goal~~ confirmed
     2026-09-23 as suggestion-only — it suggests opponents, the challenge is still sent by hand;
     still not this task) —
