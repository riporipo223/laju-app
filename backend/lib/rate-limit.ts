...
export const RATE_LIMIT_RULES = {
  ...
  "club.create": [{ windowSeconds: 3600, limit: 5 }],
  "club.browse": [{ windowSeconds: 60, limit: 30 }],
  "club.members": [{ windowSeconds: 60, limit: 30 }],
  "club.join": [{ windowSeconds: 3600, limit: 10 }],
  "club.leave": [{ windowSeconds: 3600, limit: 10 }],
